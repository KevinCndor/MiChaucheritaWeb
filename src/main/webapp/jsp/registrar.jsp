					...
					<form method="POST" action="../AccesoController?ruta=crearusuario"
						...
						<div>
							...
							<input type="text" name="apellido"
								placeholder="Ingrese su Apellido" required class="styled-input">
						</div>
						<div>
							<p>Usuario</p>
							<input type="text" name="usuario"
								placeholder="Ingrese su Usuario" required class="styled-input">
						</div>
						<div>
							<p>Contraseña</p>
						...
						<button type="submit" value="Iniciar"
							class="botonRegistrar fondoBotones">Crear</button>
					</form>
				</div>
