	...
	<script>
	    ...
	    cuentasOrigen.forEach(cuenta => {
	        cuenta.addEventListener("click", () => {
	            ...
	            // Tambi�n podr�as hacer alg�n estilo para resaltar la cuenta seleccionada si es necesario
	        });
	    });
	</script>
	<script>
...
function validarMonto(input) {
    if (input.value < 0) {
        ...
        input.setCustomValidity(""); // Restablecer la validaci�n personalizada
    }
}
</script>
